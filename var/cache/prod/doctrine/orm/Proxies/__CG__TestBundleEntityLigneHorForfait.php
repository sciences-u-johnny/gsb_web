 ...
 */
class LigneHorForfait extends \TestBundle\Entity\LigneHorForfait implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TestBundle\\Entity\\LigneHorForfait' . "\0" . 'id', '' . "\0" . 'TestBundle\\Entity\\LigneHorForfait' . "\0" . 'date', '' . "\0" . 'TestBundle\\Entity\\LigneHorForfait' . "\0" . 'valide', '' . "\0" . 'TestBundle\\Entity\\LigneHorForfait' . "\0" . 'montant', '' . "\0" . 'TestBundle\\Entity\\LigneHorForfait' . "\0" . 'libelle', '' . "\0" . 'TestBundle\\Entity\\LigneHorForfait' . "\0" . 'fichefrai'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LigneHorForfait $proxy) {
