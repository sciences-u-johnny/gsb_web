 ...
 */
class Visiteur extends \TestBundle\Entity\Visiteur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'TestBundle\\Entity\\Visiteur' . "\0" . 'nom', '' . "\0" . 'TestBundle\\Entity\\Visiteur' . "\0" . 'prenom', '' . "\0" . 'TestBundle\\Entity\\Visiteur' . "\0" . 'adresse', '' . "\0" . 'TestBundle\\Entity\\Visiteur' . "\0" . 'ville', '' . "\0" . 'TestBundle\\Entity\\Visiteur' . "\0" . 'cP', '' . "\0" . 'TestBundle\\Entity\\Visiteur' . "\0" . 'dateEmbauche', '' . "\0" . 'TestBundle\\Entity\\Visiteur' . "\0" . 'DateCreation', '' . "\0" . 'TestBundle\\Entity\\Visiteur' . "\0" . 'ficheFrai', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
