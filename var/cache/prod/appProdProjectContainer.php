...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('du9oSyskp9', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cpjqHm5foq', 0, 'oFqBBzSdk5Zo+UHsUmt18g', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '94.23.221.178', 'port' => 3306, 'dbname' => 'Applifrais', 'user' => 'admin', 'password' => 'adminppe1517i', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\TestBundle\\Entity'))), 'TestBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('TestBundle' => 'TestBundle\\Entity'));
        ...
        $b->addCustomStringFunction('Month', 'TestBundle\\DQL\\Month');
        $b->addCustomStringFunction('Year', 'TestBundle\\DQL\\Year');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_46e85be4b3eb8d0ce7236d94f876870de627e4fff656a6f96456c1b968ebc54c');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('TestBundle\\Entity\\Visiteur');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('TestBundle\\Entity\\Visiteur');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('TestBundle\\Entity\\Visiteur');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('TestBundle\\Entity\\Visiteur');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater'), $this->get('doctrine')->getManager(NULL), 'TestBundle\\Entity\\Visiteur');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/comptable');

        $l = new \Symfony\Component\Security\Http\AccessMap();
        $l->add($h, array(0 => 'ROLE_ADMIN'), NULL);
        $l->add($i, array(0 => 'ROLE_ADMIN'), NULL);
        $l->add($j, array(0 => 'ROLE_UTILISATEUR'), NULL);
        $l->add($k, array(0 => 'ROLE_COMPTABLE'), NULL);
        ...
        $o->setOptions(array('default_target_path' => 'test_homepage', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    {
        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer(array(0 => new \FOS\RestBundle\Serializer\Normalizer\FormErrorNormalizer($this->get('translator.default')), 1 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 2 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 3 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(), 4 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(new \Symfony\Component\Serializer\Mapping\Factory\CacheClassMetadataFactory(new \Symfony\Component\Serializer\Mapping\Factory\ClassMetadataFactory(new \Symfony\Component\Serializer\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Serializer\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')))), NULL), $this->get('cache.serializer')), NULL, $this->get('property_accessor'), NULL)), array(0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => new \Symfony\Component\Serializer\Encoder\JsonEncoder()));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\OCTestBundle/Resources/views'), 'OCTest');
        $instance->addPath(($this->targetDirs[3].'\\src\\TestBundle\\SeTestBundle/Resources/views'), 'SeTest');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('76910d61e88699b919b84485d9b760b8a824798f');
    }
    ...
    {
        return $this->services['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('D8nHpb1te8', 0, 'oFqBBzSdk5Zo+UHsUmt18g', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6Hs10yLj5-', 0, 'oFqBBzSdk5Zo+UHsUmt18g', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_UTILISATEUR' => array(0 => 'ROLE_USER'), 'ROLE_COMPTABLE' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_UTILISATEUR', 1 => 'ROLE_USER', 2 => 'ROLE_COMPTABLE'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'OCTestBundle' => 'OCTestBundle\\OCTestBundle',
                'SeTestBundle' => 'TestBundle\\SeTestBundle\\SeTestBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'FOSRestBundle' => 'FOS\\RestBundle\\FOSRestBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdProjectContainer',
            'database_host' => '94.23.221.178',
            'database_port' => 3306,
            'database_name' => 'Applifrais',
            'database_user' => 'admin',
            'database_password' => 'adminppe1517i',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '76910d61e88699b919b84485d9b760b8a824798f',
            'locale' => 'en',
            'justificatif_directory' => ($this->targetDirs[3].'\\app/../web/Uplaod/Jusificatif'),
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '76910d61e88699b919b84485d9b760b8a824798f',
            ...
            'validator.mapping.cache.prefix' => 'validator_6b83172dd429eb09ba2daa93efade8fd1256c8b47e56cd0efc2635d3ea1c5aa8',
            ...
            'fos_user.model.user.class' => 'TestBundle\\Entity\\Visiteur',
